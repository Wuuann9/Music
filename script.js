...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const trendingBlock = document.getElementById('trending-block');
    trendingBtn.addEventListener('click', function() {
        // Thêm hoặc loại bỏ class active khi click
        this.classList.toggle('active');

        // Kiểm tra nếu khối trending đang ẩn, thì hiển thị, ngược lại thì ẩn đi
        if (trendingBlock.style.display === "none" || trendingBlock.style.display === "") {
            trendingBlock.style.display = "block";
        } else {
            trendingBlock.style.display = "none";
        }
    });
...
const app = {
    ...
    songs: [
        {
            ...
            time: "",
            path:
                "assets/music/Dunglamtraitimanhdau.mp3",
            image:
                "assets/img/sepTung.jpg",
            lyrics: "Hình như trong lòng anh đã không còn hình bóng ai ngoài em đâu <br> Hằng đêm anh nằm thao thức suy tư, chẳng nhớ ai ngoài em đâu <br>Vậy nên không cần nói nữa, yêu mà đòi nói trong vài ba câu? <br>Cứ cố quá đâm ra lại hâm<br>Uhm, đau hết cả đầu! <br>Ðợi chờ em trước nhà từ sáng đến trưa, chiều, tối mắc màn đây luôn <br>Ngược nắng hay là ngược gió, miễn anh thấy em tươi vui không buồn<br>Chỉ cần có thấy thế thôi, mây xanh chan hoà<br>Thấy thế thôi, vui hơn có quà<br>Và bước kế tiếp anh lại gần hơn chút đó nha<br>Rồi ngày ấy cuối cùng đã tìm đến, ta nào đâu hay<br>Anh sẽ không để vụt mất đi cơ duyên ông trời trao tay<br>Còn đắn đo băn khoăn gì nữa? Tiếp cận em ngay<br>Cố gắng sao không để em nghi ngờ dù một giây lúc này<br>Ðược đứng bên em, anh hạnh phúc, tim loạn nhịp tung bay<br>Chắc chắn anh thề anh sẽ không bao giờ quên ngày hôm nay<br>Chính em, chính em, tương tư mình em thôi<br>Mãi theo sau mình em thôi<br>Mãi si mê mình em thôi<br>Mãi yêu thương mình em<br>Vậy thì anh xin chết vì người anh thương<br>Có biết bao nhiêu điều còn đang vấn vương<br>Dành cho em, dành hết ân tình anh mang một đời<br>Ðừng làm trái tim anh đau<br>Vậy thì anh xin chết vì người anh thương<br>Nên có biết bao nhiêu điều còn đang vấn vương<br>Dành cho em, dành hết ân tình anh mang một đời<br>Ðừng làm trái tim anh đau ",
            genre: "Beat",
        },
        {
        ...
        },
        {
            ...
            lyrics:"Có cơn mưa nào đôi mình đi qua<br>Anh đến bên em<br>Ngày đôi mình chia xa<br>Mỗi lá rơi bên hồ<br>Nỗi cô đơn lớn lên Mùa thu ấy<br>Em không còn bên cạnh anh nữa<br>Anh vẫn đứng nơi đây<br>Chờ em cùng cơn mưa Chúng ta sau này<br>Chẳng có chúng ta bây giờ<br>Một người âm thầm<br>Đứng dưới mưa nhìn em<br>Một người giữa thành phố Vẫn cứ chờ em<br>Vì sao cứ nơi đó mà<br>Anh dần xa nơi đâu<br>Giờ này chỉ nỗi nhớ<
co duyen nQuang khong no<br>Tra em ve lai noi xu la day mong mo<br>Ta xa nhau roi Quang ki niem chang con phai khong<br>Doi mat ai buon dung trong chieu mai hoai ngong trong<br><br>Co duyen gap nang nQuang sau cung tinh cung lo lang<br>Ngam ngui cam nin xem em tay trong tay cung nguoi ay<br>Thoi thi em hay ve noi gam hoa lua la<br>Noi cho em tam than ngoc nga<br><br>O noi chon khue phong cau mong em khong khoc nam thang<br>Mong nguoi thuong cua em yeu that long<br>Phia noi cuoi con duong ta se ve dau<br>Doi cau thuong nho nhau nay cung phai mau<br><br>Noi dau cu day vo doi anh co lieu mai<br>Hai ta co duyen nQuang chang no nhau<br>Hoa vang roi thu ve chon day<br>Nghe nhu buoc chan ai ke ben them<br><br>Tim nhoi dau nQuang dan long khong buon<br>Sau tren doi mi ngay mai roi tinh chet<br>Thoi thi em hay ve noi gam hoa lua la<br>noi cho em tam than ngoc nga<br><br>O noi chon khue phong cau mong em khong khoc<br>Mong nguoi thuong cua em yeu that long<br>Phia noi cuoi con duong ta se di ve dau<br>Doi cau thuong nho nhau nay cung phai mau",
            genre: "Remix",
        },
        {
    ...
    handleEvents: function(){
        ...
        // Dữ liệu với tên bài hát
        const labels = ['23:00', '01:00', '03:00', '05:00', '07:00', '09:00', '11:00', '13:00', '15:00', '17:00', '19:00', '21:00'];
        const dataPoints = [
            {x: '23:00', y: 10, song: '100 Years Love'},
            {x: '01:00', y: 20, song: 'Đi về nhà'},
            {x: '03:00', y: 15, song: 'Hẹn em ở lần yêu thứ 2'},
            {x: '05:00', y: 25, song: '1 phút'},
            {x: '07:00', y: 30, song: 'Những lời hứa bỏ quên'},
            {x: '09:00', y: 45, song: 'Từng là'},
            {x: '11:00', y: 40, song: 'Khi phải quên đi'},
            {x: '13:00', y: 50, song: 'Đừng làm trái tim anh đau'},
            {x: '15:00', y: 45, song: 'Đưa nhau đi trốn'},
            {x: '17:00', y: 35, song: 'Cắt đôi nỗi sầu'},
            {x: '19:00', y: 25, song: 'Vì ngày hôm nay em cưới rồi'},
            {x: '21:00', y: 20, song: 'Ước mơ của mẹ'}
        ];
        ...
        const myChart = new Chart(ctx, {
            ...
            data: {
                labels: labels,
                datasets: [{
                    label: 'Biểu đồ #zingchart',
                    data: dataPoints.map(point => ({ x: point.x, y: point.y })),  // Chỉ sử dụng x, y để vẽ biểu đồ
                    backgroundColor: 'rgba(88, 115, 255,0.5)',
                    ...
                    tooltip: {
                        ...
                        callbacks: {
                            label: function(context) {
                                const index = context.dataIndex;  // Lấy chỉ số của điểm dữ liệu hiện tại
                                const songName = dataPoints[index].song;  // Lấy tên bài hát
                                const value = context.raw.y;  // Lấy giá trị y
                                return `${songName}: ${value}`;  // Hiển thị tên bài hát và giá trị
                            }
                        }
                    }
                },
